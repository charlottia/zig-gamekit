...
pub fn ogImageButton(texture: imgui.ImTextureID, size: imgui.ImVec2, uv0: imgui.ImVec2, uv1: imgui.ImVec2, frame_padding: c_int, bg_col: imgui.ImVec4, tint_col: imgui.ImVec4) bool {
    // TODO: remove when windows can handle passing imgui.ImVec4s
